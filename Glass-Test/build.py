...
files = ['INSTALL.md', 'Glass-Vergleich.html', 'Liquid-Glass-Demo.html', 'index.html', 'configurator.js', 'configurator.css', 'test-module.html', 'test-sidebar.html', 'sidebar-demo.js', 'OPTIK.md', 'build.py']
with ZipFile(root / 'ha-liquid-glass-0.5.0.zip', 'w', ZIP_DEFLATED) as archive:
